(module
  ...
  (func $prlrt::__prlt_token::__prlt_token__ (type $t1) (param $p0 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get $p0)
  (func $prlrt::__prlt_bigint::gas_coefficient___const (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    i64.load
    call $GCLBigintGetEmbeddedSize
    i32.const 3
    i32.shr_u)
  (func $prlrt::__prlt_bigint::__prlt_bigint_long_long_ (type $t1) (param $p0 i32) (result i32)
    (local $l1 i64)
    local.get $p0
    i32.const 0
    i32.store offset=8
  ...
  (func $Contract_chsimu_Token_6_TransactionCallEntry (type $t12) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get $p3)
  (func $prlrt::__prlt_bigint::map_from_serialized_data_unsigned_char*&__unsigned_int&__bool_ (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    ...
    i32.const 0
    i32.ne)
  (func $std::__2::shared_ptr<prlrt::____token_impl>::~shared_ptr__ (type $t1) (param $p0 i32) (result i32)
    ...
    block $B0
      block $B1
        block $B2
          ...
          i32.const 1
          i32.sub
          br_table $B1 $B1 $B2 $B1 $B1 $B1 $B1 $B1 $B1 $B1 $B0
        end
        block $B3
          local.get $l4
          i32.load offset=8
  ...
  (func $prlrt::__prlt_bigint::get_serialize_size___const (type $t1) (param $p0 i32) (result i32)
    global.get $__memory_base
    i32.const 1576
    i32.add
    i32.load
  ...
  (func $std::__2::__shared_ptr_pointer<prlrt::____token_impl*__std::__2::shared_ptr<prlrt::____token_impl>::__shared_ptr_default_delete<prlrt::____token_impl__prlrt::____token_impl>__std::__2::allocator<prlrt::____token_impl>>::__get_deleter_std::type_info_const&__const (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
    ...
    i32.eq
    select)
  (func $prlrt::__prlt_bigint::bigger_gas_coefficient_prlrt::__prlt_bigint_const&__const (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
    local.get $p0
  ...
  (func $std::__2::vector<prlrt::__prlt_token__std::__2::allocator<prlrt::__prlt_token>>::__recommend_unsigned_long__const (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
    ...
    i32.ge_u
    select)
  (func $std::__2::__split_buffer<prlrt::__prlt_token__std::__2::allocator<prlrt::__prlt_token>&>::__split_buffer_unsigned_long__unsigned_long__std::__2::allocator<prlrt::__prlt_token>&_ (type $t12) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (result i32)
    (local $l4 i32)
    local.get $p0
    i32.const 0
    i32.store offset=12
  ...
  (func $__cxa_throw (type $t0) (param $p0 i32)
    call $abort
    unreachable)
  (func $__cxa_allocate_exception (type $t11) (result i32)
    call $abort
    unreachable)
  (func $__errno_location (type $t11) (result i32)
    ...
    i32.const 1588
    i32.add)
  (func $strlen (type $t1) (param $p0 i32) (result i32)
    (local $l1 i32) (local $l2 i32) (local $l3 i32)
    block $B0
      local.get $p0
      local.tee $l1
    ...
    local.get $p0
    i32.sub)
  (func $std::__2::__shared_count::~__shared_count__ (type $t1) (param $p0 i32) (result i32)
    local.get $p0)
  (func $long_std::__2::__libcpp_atomic_refcount_decrement<long>_long&_ (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    local.get $p0
    i32.load
    i32.const 1
    ...
    i32.store
    local.get $p0)
  (func $operator_new_unsigned_long_ (type $t1) (param $p0 i32) (result i32)
    (local $l1 i32)
    local.get $p0
    i32.const 1
    local.get $p0
    ...
    local.get $l1)
  (func $std::exception::exception__ (type $t1) (param $p0 i32) (result i32)
    local.get $p0
  ...
  (func $std::__2::__libcpp_refstring::__libcpp_refstring_char_const*_ (type $t2) (param $p0 i32) (param $p1 i32)
    ...
    call $__memcpy
    i32.store)
  (func $std::__2::basic_string<char__std::__2::char_traits<char>__std::__2::allocator<char>>::__get_pointer___const (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    call $std::__2::basic_string<char__std::__2::char_traits<char>__std::__2::allocator<char>>::__is_long___const
    if $I0
      local.get $p0
    ...
    local.get $p0)
  (func $std::__2::basic_string<char__std::__2::char_traits<char>__std::__2::allocator<char>>::__is_long___const (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    i32.load8_u offset=11
    i32.const 7
    i32.shr_u)
  (func $std::__2::char_traits<char>::move_char*__char_const*__unsigned_long_ (type $t10) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    local.get $p2
    if $I0
      block $B1
        local.get $p0
  ...
  (func $std::__2::basic_string<char__std::__2::char_traits<char>__std::__2::allocator<char>>::__get_long_cap___const (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    i32.load offset=8
    i32.const 2147483647
    i32.and)
  (func $std::__2::char_traits<char>::assign_char&__char_const&_ (type $t2) (param $p0 i32) (param $p1 i32)
    ...
    i32.load8_u
    i32.store8)
  (func $std::__2::basic_string<char__std::__2::char_traits<char>__std::__2::allocator<char>>::__recommend_unsigned_long_ (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    i32.const 11
    i32.ge_u
    if $I0 (result i32)
  ...
  (func $std::__2::basic_string<char__std::__2::char_traits<char>__std::__2::allocator<char>>::__invalidate_all_iterators__ (type $t0) (param $p0 i32)
    nop)
  (func $std::__2::char_traits<char>::copy_char*__char_const*__unsigned_long_ (type $t10) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    local.get $p2
    if $I0
      local.get $p0
      local.get $p1
  ...
  (func $__dynamic_cast (type $t8) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get $p1)
  (func $__cxxabiv1::__class_type_info::process_found_base_class___cxxabiv1::__dynamic_cast_info*__void*__int__const (type $t10) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    (local $l3 i32)
    local.get $p0
    i32.load offset=16
    local.tee $l3
  ...
  (func $__cxxabiv1::__class_type_info::process_static_type_below_dst___cxxabiv1::__dynamic_cast_info*__void_const*__int__const (type $t10) (param $p0 i32) (param $p1 i32) (param $p2 i32)
    block $B0
      local.get $p0
      i32.load offset=4
      local.get $p1
  ...
  (func $__cxa_is_pointer_type (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    i32.eqz
    if $I0
      i32.const 0
    ...
    i32.const 0
    i32.ne)
  (func $std::exception::what___const (type $t1) (param $p0 i32) (result i32)
    global.get $__memory_base
    i32.const 50
    i32.add)
  (func $std::bad_alloc::what___const (type $t1) (param $p0 i32) (result i32)
    global.get $__memory_base
    i32.const 104
    i32.add)
  (func $std::bad_array_new_length::what___const (type $t1) (param $p0 i32) (result i32)
    global.get $__memory_base
    i32.const 70
    i32.add)
  (func $std::logic_error::~logic_error__ (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    global.get $GOT.data.internal.vtable_for_std::logic_error
    i32.const 8
    i32.add
  ...
  (func $std::logic_error::~logic_error__.1 (type $t0) (param $p0 i32)
    ...
    local.get $p0
    call $free)
  (func $std::logic_error::what___const (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    i32.load offset=4)
  (func $std::runtime_error::~runtime_error__ (type $t1) (param $p0 i32) (result i32)
    local.get $p0
    global.get $GOT.data.internal.vtable_for_std::runtime_error
    i32.const 8
    i32.add
  ...
  (func $std::runtime_error::~runtime_error__.1 (type $t0) (param $p0 i32)
    ...
    local.get $p0
    call $free)
  (func $stackSave (type $t11) (result i32)
    global.get $__stack_pointer)
  ...
  (global $GOT.data.internal.typeinfo_for_std::length_error (mut i32) (i32.const 1532))
  (global $GOT.data.internal.vtable_for_std::length_error (mut i32) (i32.const 1512))
  (global $GOT.func.internal.std::bad_array_new_length::~bad_array_new_length__ (mut i32) (i32.const 2))
  (global $GOT.data.internal.typeinfo_for_std::bad_array_new_length (mut i32) (i32.const 1448))
  (global $GOT.data.internal.vtable_for_std::exception (mut i32) (i32.const 1408))
  (global $GOT.data.internal.vtable_for_std::logic_error (mut i32) (i32.const 1460))
  (global $GOT.data.internal.vtable_for_std::runtime_error (mut i32) (i32.const 1480))
  (global $GOT.data.internal.__cxa_new_handler (mut i32) (i32.const 1592))
  (global $GOT.data.internal.typeinfo_for___cxxabiv1::__class_type_info (mut i32) (i32.const 1188))
  (global $GOT.data.internal.typeinfo_for___cxxabiv1::__shim_type_info (mut i32) (i32.const 1176))
  (global $GOT.data.internal.typeinfo_for___cxxabiv1::__pointer_type_info (mut i32) (i32.const 1212))
  (global $GOT.data.internal.vtable_for_std::bad_alloc (mut i32) (i32.const 1368))
  (global $GOT.data.internal.vtable_for_std::bad_array_new_length (mut i32) (i32.const 1388))
  ...
