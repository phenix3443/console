(module
  ...
  (type (;4;) (func))
  (import "env" "gas_limit" (global $gas_limit i64))
  (import "env" "gas_cost"  (global $gas_cost (mut i64)))
  ...
  (func $__wasm_call_dtors (type 4)
    call $dummy
    call $dummy)
  (func $_malloc (type 2) (param i32) (result i32)
    local.get 0
    call $malloc)
  (func $_free (type 3) (param i32)
    local.get 0
    call $free)
  (func $guest_accGasCost (type 3) (param i32)
    local.get 0
    i64.load
    gas.cost)
  (func $guest_sentEvent (type 4)
    i32.const 1046
    i32.const 7
    i32.const 1024
    i32.const 21
    event
    drop)
  (func $_malloc.command_export (type 2) (param i32) (result i32)
    local.get 0
    call $_malloc
    call $__wasm_call_dtors)
  (func $_free.command_export (type 3) (param i32)
    local.get 0
    call $_free
    call $__wasm_call_dtors)
  (func $guest_accGasCost.command_export (type 3) (param i32)
    local.get 0
    call $guest_accGasCost
    call $__wasm_call_dtors)
  (func $guest_sentEvent.command_export (type 4)
    call $guest_sentEvent
    call $__wasm_call_dtors)
  (table (;0;) 1 1 funcref)
  (memory (;0;) 2)
  ...
  (export "guest_accGasCost" (func $guest_accGasCost.command_export))
  (export "guest_sentEvent" (func $guest_sentEvent.command_export))
  (data $.rodata (i32.const 1024) "Mined 1000 CAT Tokens\00event_1\00"))
