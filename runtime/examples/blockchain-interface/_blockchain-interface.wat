(module
  ...
  (type (;3;) (func))
  (import "env" "bcei_get_txid_size" (func $bcei_get_txid_size (type 0)))
  (import "env" "bcei_get_txid" (func $bcei_get_txid (type 0)))
  (import "env" "bcei_log" (func $bcei_log (type 1)))
  ...
  (func $__wasm_call_dtors (type 3)
    call $dummy
    call $dummy)
  (func $_malloc (type 0) (param i32) (result i32)
    local.get 0
    call $malloc)
  (func $_free (type 2) (param i32)
    local.get 0
    call $free)
  (func $print_txid (type 3)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_malloc.command_export (type 0) (param i32) (result i32)
    local.get 0
    call $_malloc
    call $__wasm_call_dtors)
  (func $_free.command_export (type 2) (param i32)
    local.get 0
    call $_free
    call $__wasm_call_dtors)
  (func $print_txid.command_export (type 3)
    call $print_txid
    call $__wasm_call_dtors)
  (table (;0;) 1 1 funcref)
  (memory (;0;) 2)
  ...
  (export "print_txid" (func $print_txid.command_export)))
